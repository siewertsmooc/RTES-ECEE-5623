...
void ptimer_test(void) {
  ...
  struct itimerspec release_itime;
  struct itimerspec last_release_itime;
  struct itimerspec dterm_itime;
  struct itimerspec last_dterm_itime;

  struct sigevent ReleaseEvent;
  struct sigaction ReleaseAction;

  struct sigevent TermEvent;
